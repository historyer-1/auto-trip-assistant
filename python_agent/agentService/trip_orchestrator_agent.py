...
from agentService.weather_search_agent import WeatherSearchAgent
from agentService.hotel_search_agent import HotelSearchAgent
from agentService.itinerary_planner_agent import ItineraryPlannerAgent
...
class TripOrchestratorAgent:
    ...
    async def ainvoke(self, request: TripRequest) -> TripPlan:
        ...
        # 并发执行三个搜索任务，利用 LLM/工具 I/O 等待时间提升吞吐。
        ...
        # 打印 hotel_result 和 weather_result 的前 300 字，确认缺失发生阶段
        ...
        return await self.planner_agent.ainvoke(context)
